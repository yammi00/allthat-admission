...
CATEGORIES = [
    {
        ...
        "google": [
            ...
            "수능 수학 1등급 컷 서울 경기",
            "6월 9월 수능 수학 모의평가 서울",
            "수능 과학탐구 모의평가 서울 경기",    # 과탐 ★★
            "수능 국어 영어 모의평가 서울",        # 국영사탐 ★
        ],
        "naver_blog": [
    ...
    },
    {
        ...
        "emoji": "🎓",
        "google": [
            "서울대 연세대 고려대 수시 수학 최저",   # 수학 ★★★
            "성균관대 한양대 서강대 수시 수학 논술",
            "중앙대 경희대 수시 수학 서울 경기",
            "인서울 수시 과탐 최저학력기준",          # 과탐 ★★
            "인서울 수시 국어 영어 최저",             # 국영사탐 ★
        ],
        "naver_blog": [
    ...
    },
    {
        ...
        "emoji": "📊",
        "google": [
            "서울대 연세대 고려대 정시 수학 반영비율",  # 수학 ★★★
            "성균관대 한양대 정시 수학 가중치 2027",
            "수도권 대학 정시 수학 컷 서울 경기",
            "인서울 정시 과탐 반영비율 유불리",         # 과탐 ★★
            "인서울 정시 국어 영어 반영비율",            # 국영사탐 ★
        ],
        "naver_blog": [
            "서울권 35개 대학 정시 수학 반영비율 분석",
            "강남 분당 정시 수학 컨설팅 전략",
            "인서울 정시 과탐 수학 가중치 비교",
            "수능 국어 영어 서울권 정시 반영비율",
        ],
        "naver_cafe": [
    ...
    },
    {
        ...
        "google": [
            "2028 수능 개편 수학 서울 경기",
            "교육부 수학 과학 교육과정 개편 발표",
            "수능 선택과목 개편 수학 과탐 국어",
        ],
        "naver_blog": [
            "2028 수능 수학 과탐 개편 서울 경기 영향",
            "수능 개편 수학 과학 국어 영어 변화",
        ],
        "naver_cafe": [
            "2028 수능 수학 과탐 개편 인서울 영향",
        ],
    },
    {
        "id": "ebs",
    ...
    },
    {
        ...
        "google": [
            "킬러문항 수학 서울 경기",              # 수학 ★★★
            "수학 사교육 정책 수도권",
            "수능 과탐 트렌드 서울 경기 2027",      # 과탐 ★★
            "수능 국어 영어 입시 트렌드 수도권",     # 국영사탐 ★
        ],
        "naver_blog": [
            "강남 분당 수학 입시 트렌드 분석",
            "수도권 수학 과탐 학습법 컨설팅",
